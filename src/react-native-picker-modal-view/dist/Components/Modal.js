...
export class ModalComponent extends React.PureComponent {
  ...
  componentWillReceiveProps(nextProps, nextState) {
    if (
      this.props.selected &&
      nextProps.selected &&
      this.props.selected.Name !== nextProps.selected.Name &&
  ...
  render() {
    ...
    return React.createElement(
      React.Fragment,
      null,
      React.createElement(SelectBoxComponent, {
        disabled: disabled || !items || items.length === 0,
        selectedObject: selectedObject,
        chooseText:
          selected && selected.Name ? selected.Name : selectPlaceholderText,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              !showAlphabeticalIndex &&
                React.createElement(AlphabetComponent, {
                  setAlphabet: alphabet => this.setAlphabet(alphabet),
  ...
  _getFilteredData() {
    ...
    return items.filter(
      l =>
        l.Name.toLocaleLowerCase().indexOf(searchText.toLocaleLowerCase()) > -1
    );
  }
  getFilteredData() {
