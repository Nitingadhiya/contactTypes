...
class RejectModal extends Component {
    ...
    APICaller(
      ...
      if (json) {
        if (json.status && json.status === GlobalVar.responseInvalidCode) {
          ...
          // console.log(json.data.errors.reasons[0], "Look");
          this.setState({
  ...
  textInputChange = (stateVal, value, index) => {
    ...
    console.log(this.state.textInputArray, "TextInput");
  };
                ...
                <View style={Styles.innerView}>
                  ...
                  >
                    <Text style={Styles.heading}>
                      {Helper.translation(
                        "Words.Your feedback is important to us. We would like to provide you with more suitable offers in the future. We would be glad if you tell us why this offer is not interesting",
